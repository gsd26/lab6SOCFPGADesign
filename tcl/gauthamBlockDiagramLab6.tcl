...
proc create_root_design { parentCell } {
  ...
  # Create instance: ILA_Probe, and set properties
  set ILA_Probe [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ILA_Probe ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins radio_tuner_0/S00_AXI]

  # Create port connections
  connect_bd_net -net lowlevel_dac_intfc_0_bclk [get_bd_ports bclk] [get_bd_pins ILA_Probe/probe3] [get_bd_pins lowlevel_dac_intfc_0/bclk]
  connect_bd_net -net lowlevel_dac_intfc_0_latched_data [get_bd_pins ILA_Probe/probe5] [get_bd_pins lowlevel_dac_intfc_0/latched_data]
  connect_bd_net -net lowlevel_dac_intfc_0_lrck [get_bd_ports lrck] [get_bd_pins ILA_Probe/probe2] [get_bd_pins lowlevel_dac_intfc_0/lrck]
  connect_bd_net -net lowlevel_dac_intfc_0_mclk [get_bd_ports mclk] [get_bd_pins ILA_Probe/probe4] [get_bd_pins lowlevel_dac_intfc_0/mclk]
  connect_bd_net -net lowlevel_dac_intfc_0_sdata [get_bd_ports sdata] [get_bd_pins ILA_Probe/probe1] [get_bd_pins lowlevel_dac_intfc_0/sdata]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ILA_Probe/clk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins lowlevel_dac_intfc_0/clk125] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins radio_tuner_0/m00_axis_aclk] [get_bd_pins radio_tuner_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_125M/slowest_sync_clk]
