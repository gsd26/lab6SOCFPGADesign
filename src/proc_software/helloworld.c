...
int main()
{
    ...
    init_platform();
    print("\r\n\r\n\r\nLab 7 Gautham Divakar - Custom Peripheral Demonstration\n\r");
    ...
    //each read cycle read 4 bytes and you read 2048 times so that means 2048*4 so you read 8192 bytes... clock rate is 125e6 so 1 clock cycle means 8e-9 seconds


    throughput = (float)(stop_time-start_time)*8e-9;
    throughput = 8192.00 / throughput; //bytes per second
    throughput = throughput/ 1000000.00;
